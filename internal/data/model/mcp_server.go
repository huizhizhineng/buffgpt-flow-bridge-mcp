...
type McpServer struct {
	...
	IsAuth        _const.AuthTypeStatus      `json:"isAuth" gorm:"column:is_auth;type:SMALLINT;default:1;comment:服务器是否需要认证,如果开启全局认证，则所有的方法都需要认证,0未知，1 不开启，2开启平台授权，3开启service授权，4开启所有的授权"`
